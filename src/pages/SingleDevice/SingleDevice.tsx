        ...
        <CardContent>
          {loading ? (
            ...
            <div className="flex items-center gap-2">
              <div className="bg-client-secondary rounded-lg p-3">
                ...
                <p className="text-xs font-normal text-gray-500">IP Address</p>
                <p className="text-[14px] font-medium">{info?.ip_address}</p>
