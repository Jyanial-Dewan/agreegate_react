...
const SingleDevice = () => {
  ...
  // useEffect(() => {
  //   const loadClinetLocationInfo = async () => {

  //   };
  //   loadClinetLocationInfo();
  // }, [currentPage, device_id, token?.user_id]);
              ...
              <div className="w-[calc(100%-300px)] flex flex-col gap-4">
                <div className="flex flex-wrap gap-2 bg-white border p-4 rounded-lg">
                  <div className="bg-client-secondary rounded-lg p-3 w-[300px] flex-grow">
                    ...
                    <p className="text-xs font-normal text-gray-500">License</p>
                    <p className="text-[14px] font-medium">
                  ...
                  <div className="bg-amber-50 rounded-lg p-3 w-[300px] flex-grow">
                    ...
                    <p className="text-xs font-normal text-gray-500">OS Name</p>
                  ...
                  <div className="bg-GREEN-100 rounded-lg p-3 w-[300px] flex-grow">
                    ...
                    <p className="text-xs font-normal text-gray-500">Region</p>
                    ...
                    <p className="text-[14px] font-medium">{info?.timezone}</p>
                    <p className="text-xs font-normal text-gray-500">
                      ZIP Code
                    </p>
